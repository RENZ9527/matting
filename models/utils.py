...
class ModelLogger:
    ...
    def run_evaluation(self, model, full_size=False):
        ...
        if self.task == "depth" or self.task == "normal":
            ...
            base_dir = "/nvmedata/workspace2/users/rzc/datasets/AIM-500"
        else:
        ...
        if self.task == "depth":
            ...
            self.eval_args.gt_path = "/nvmedata/workspace2/users/rzc/datasets/AIM-500"
            self.eval_args.dataset = "aim"
