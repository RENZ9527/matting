...
MODEL_CONFIGS = {
    ...
    "matting_lora": "/opt/liblibai-models/user-workspace2/users/rzc/output/kontext_matting/20260309_e2p_setting/step-10000.safetensors",
}
def inference(
    model_root: str,
    task: str,
...
if __name__ == "__main__":
    ...
    inference(
        ...
        task="matting",  # Options: "depth", "normal", "matting"
